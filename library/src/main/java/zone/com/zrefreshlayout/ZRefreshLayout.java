...
import static zone.com.zrefreshlayout.utils.LogUtils.logE;
...
public class ZRefreshLayout extends FrameLayout {
    ...
    public void loadMoreComplete() {
        if(state!=LOADMORE_ING){
            logE("非加载状态下 loadMoreComplete");
            return ;
        }
