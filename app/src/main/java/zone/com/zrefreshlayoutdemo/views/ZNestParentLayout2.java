 ...
 *
 */
public class ZNestParentLayout2 extends LinearLayout implements NestedScrollingParent {
    ...
    public ZNestParentLayout2(Context context) {
        this(context, null);
    }

    public ZNestParentLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZNestParentLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        return super.canScrollVertically(direction);
    ...
    public class FlexScroll extends IScrollFlex {
        ...
        protected void scrollTo(int fy, boolean isAnimate) {
            ZNestParentLayout2.this.scrollTo(0, fy);
        }
        ...
        protected void scrollBy(int fx, int fy) {
            if (mIScroll.isRunning())
                mIScroll.cancel();
            scrollY += fy;
            ZNestParentLayout2.this.scrollBy(0, fy);
            scrollCallback();
        }
    }
